...
server {
  ...
  ssl_certificate /etc/letsencrypt/live/irc.parkermoo.re/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/irc.parkermoo.re/privkey.pem;
  ssl_trusted_certificate /etc/letsencrypt/live/irc.parkermoo.re/chain.pem;
