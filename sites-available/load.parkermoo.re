...
server {
    ...
    # SSL Configuration.
    ssl_certificate /etc/letsencrypt/live/load.parkermoo.re/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/load.parkermoo.re/privkey.pem;
    ...
    ssl_dhparam /opt/nginx/ssl/load.parkermoo.re/dhparams.pem;
    ...
    ssl_trusted_certificate /etc/letsencrypt/live/load.parkermoo.re/chain.pem;
