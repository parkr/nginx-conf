...
# Redirect HTTP to HTTPS from www.byparker.com to byparker.com
server {
    listen 80;
    listen [::]:80;
    server_name www.byparker.com;
    return 301 https://byparker.com$request_uri;
}


# Redirect www.byparker.com to byparker.com
server {
    ...
    ssl_trusted_certificate /etc/letsencrypt/live/byparker.com/chain.pem;
